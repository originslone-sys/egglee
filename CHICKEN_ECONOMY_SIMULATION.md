...
- Ao ser alimentada antes de completar 72h sem ração, volta a gerar ovos normalmente.
...
## 12) O que ainda pode ser decidido (opcional)

1. Revisão jurídica final do texto de termos conforme jurisdição de operação.
2. Definir se haverá modo de recuperação parcial da galinha após longos períodos sem ração (antes das 72h).
3. Definir política de compensação ao usuário em caso de indisponibilidade sistêmica que afete alimentação automática.
