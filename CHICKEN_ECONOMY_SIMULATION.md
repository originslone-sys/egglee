...
1. Definir timeout exato para morte por falta de ração (ex.: após 48h sem alimentação).
2. Definir tabela de alertas automáticos no admin (ex.: inflação semanal > X%).
3. Revisão jurídica final do texto de termos conforme jurisdição de operação.
